      ...
      <div className="container mx-auto px-6 py-5">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2 group micro-interaction ml-1">
            ...
            <h1 className="text-lg md:text-[1.75rem] font-display font-black text-luxury-gradient group-hover:scale-105 transition-transform luxury-text-shadow">SavannahDynasty</h1>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-6 -ml-4">
            ...
            {isAdmin && <Link to="/admin/cats" className={`text-[0.75rem] font-semibold transition-all duration-300 relative group micro-interaction ${isActive("/admin/cats") ? "text-primary luxury-text-shadow" : "text-foreground/70 hover:text-primary"}`}>
                ⚙️ Админ
